<script>
  ...
  let open = $derived(!!$tmuxWindowPickerOpen);
        ...
        <div class="px-6 pt-5 pb-4 border-b border-ctp-surface0">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
              ...
              <div>
                <Dialog.Title class="text-sm font-semibold text-ctp-text m-0 p-0">Choose window</Dialog.Title>
                <Dialog.Description class="text-[11px] text-ctp-overlay0 mt-0.5 m-0 p-0 font-mono">{sessionName}</Dialog.Description>
              </div>
            </div>
